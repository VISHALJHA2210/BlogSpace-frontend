...
const CommentCard=({index, leftVal, commentData})=>{
    ...
    let {commented_by:{personal_info: {profile_img, fullname, username:commeneted_by_username}}, commentedAt, comment,_id, children}= commentData;
        ...
        <div className="w-full" style={{paddingLeft:`${leftVal * 10}px`}}>
            <div className="my-5 p-6 rounded-md border border-grey">
                <div className="flex gap-3 items-center mb-8">
                    ...
                    <p className="line-clamp-1">{fullname} @{commeneted_by_username}</p>
                ...
                <div className="flex gap-5 items-center mt-5">
                    ...
                    {
                        username == commeneted_by_username || username == blog_author ? 
                        <button className="p-2 px-3 rounded-md bg-grey ml-auto hover:bg-red/30 hover:text-red flex items-center" onClick={deleteComment}>
