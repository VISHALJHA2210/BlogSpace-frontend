        ...
        <div className="flex gap-2 max-lg:mb-6 max-lg:pb-4 border-grey max-lg:border-b">
            {
                Object.keys(stats).map((key, i)=>{
                    return !key.includes("parent") ? <div className={"flex flex-col items-center w-full h-full justify-center p-4 px-6 " + (i!=0 ? "border-grey border-l " : "")} key={i}>
...
export const ManagePublishedBlogCard=({blog})=>{
    ...
    let {blog_id, banner, title, publishedAt, activity} = blog;
