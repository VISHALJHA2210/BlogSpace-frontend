...
const Notifications=()=>{
    ...
    let {userAuth, userAuth:{access_token, new_notif_available}, setUserAuth}=useContext(UserContext);
    ...
    const fetchNotifications = ({page, deletedDocCount=0})=>{
        ...
        .then(async ({data:{notifications:data}})=>{
            ...
            if(new_notif_available){
                setUserAuth({...userAuth, new_notif_available:false})
            }
