...
const PageNotFound=()=>{
    ...
    return(
        <section className="h-cover relative p-10 flex flex-col items-center gap-20 text-center">
            ...
            <img src={theme == "light" ? darkPageNotFound : lightPageNotFound} className="select-none w-72 aspect-square object-cover rounded" />

            <h1 className="text-4xl font-gelasio leading-7">Page Not Found</h1>
            <p className="text-dark-grey text-xl leading-7 -mt-8">The page that you are looking for does not exist. Head back to the <Link to="/" className="text-black text-xl underline">home page</Link>
            </p>
