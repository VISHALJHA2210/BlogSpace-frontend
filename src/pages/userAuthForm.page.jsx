    ...
    const handleSubmit=(e)=>{
        ...
        if(fullname){
            if(fullname.length < 3){
                return toast("Fullname must be at leat 3 letters long");
            }
        }
        if(!email.length){
        ...
        if(!passwordRegex.test(password)){
            return toast("Password should be 6 to 20 characters long, with a numeric, 1 lowercase and 1 uppercase letter");
        }
